...
// INDEX
// GET /posts
router.get('/se-posts', requireToken, (req, res, next) => {
  Sepost.find()
    .then(posts => {
...
router.get('/se-posts/:id', requireToken, (req, res, next) => {
...
router.patch('/se-posts/:id', requireToken, removeBlanks, (req, res, next) => {
...
router.delete('/se-posts/:id', requireToken, (req, res, next) => {
  Sepost.findById(req.params.id)
    .then(handle404)
    .then(post => {
