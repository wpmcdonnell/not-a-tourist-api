...
const Dcpost = require('../models/dcpost')
...
// INDEX
// GET /posts
router.get('/dc-posts', requireToken, (req, res, next) => {
  Dcpost.find()
    .then(posts => {
...
router.get('/dc-posts/:id', requireToken, (req, res, next) => {
  // req.params.id will be set based on the `:id` in the route
  Dcpost.findById(req.params.id)
    .then(handle404)
...
// CREATE
// POST /posts
router.post('/dc-posts', requireToken, (req, res, next) => {
  // set owner of new post to be current user
  req.body.post.owner = req.user.id

  Dcpost.create(req.body.post)
...
router.patch('/dc-posts/:id', requireToken, removeBlanks, (req, res, next) => {
...
router.delete('/dc-posts/:id', requireToken, (req, res, next) => {
  Dcpost.findById(req.params.id)
    .then(handle404)
    .then(post => {
