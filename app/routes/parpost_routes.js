...
const Parpost = require('../models/parpost')
...
// INDEX
// GET /posts
router.get('/paris-posts', requireToken, (req, res, next) => {
  Parpost.find()
    .then(posts => {
...
router.get('/paris-posts/:id', requireToken, (req, res, next) => {
  // req.params.id will be set based on the `:id` in the route
  Parpost.findById(req.params.id)
    .then(handle404)
...
// CREATE
// POST /posts
router.post('/paris-posts', requireToken, (req, res, next) => {
  // set owner of new post to be current user
  req.body.post.owner = req.user.id

  Parpost.create(req.body.post)
...
router.patch('/paris-posts/:id', requireToken, removeBlanks, (req, res, next) => {
...
router.delete('/paris-posts/:id', requireToken, (req, res, next) => {
  Parpost.findById(req.params.id)
    .then(handle404)
    .then(post => {
